          ...
          children: [
            ...
            CustomTextFormField(
                ...
                onChanged: ref
                    ...
                    .onRepitePasswordChange,
                errorMessage: ((() {
                  if (registerForm.isFormPosted) {
                    if (registerForm.password.value !=
                        registerForm.repitePassword.value) {
                     return "Las contraseñas no coinciden";
                    }
                    return registerForm.repitePassword.errorMessage;
                  }
                  return null;
                })())),
            const SizedBox(height: 50),
            SizedBox(
                ...
                child: CustomFilledButton(
                  ...
                  onPressed:
                      ref.watch(registerFormProvider.notifier).onFormSubmit,
                )),
            Row(
